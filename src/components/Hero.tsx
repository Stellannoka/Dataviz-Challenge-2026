    ...
    >
      <Container>
        ...
        <p className="section-subtitle" style={{ textAlign: 'center', marginTop: '0.75rem', fontSize: '0.9rem' }}>
         What climate disasters cost Pacific Island nations, and how limited capacity to adapt shapes those costs.
        </p>
        ...
        <div className="section-narrative" style={{ marginTop: '3rem' }}>
          <p>
      Climate change is intensifying extreme weather events and driving a rise in sea level across the globe. However, countries do not experience the same level of risk from these changes, nor do they have the same capacity to cope with and adapt to their impacts.
          </p>
          <p>
       
Pacific Island nations are among the countries facing the greatest climate risks, yet have comparatively low adaptive capacity. Although <GlossaryTerm term="readiness">readiness</GlossaryTerm> has improved across much of the region, they still rank among the world’s most vulnerable countries. Even Tuvalu, the region’s most ready country, is the 15th most vulnerable in the world.
          </p>
        </div>
      </Container>
    </header>
