...
const STEPS: Step[] = [
  /* ---------------- PHASE 1 — RAW COUNTS (2020) ---------------- */
  {
    ...
    focus: [],
    title: "Intro",
    body: "Flood, tropical cyclone, storm surges, are among the weather-related hazards threatening Pacific Island nations. In 2020, disasters linked to these hazards directly affected 548,686 people. \n\n This includes people who were injured or fell ill, whose homes were damaged or destroyed, or whose livelihoods were disrupted or destroyed.",
  },
  {
    phase: "raw",
    kind: "highlight",
...
export default function PacificScrollyMap({
  title = "In 2020* alone, more than half a million people were directly affected by disasters.",
    ...
    <figure className="w-full" aria-label="Pacific disaster scrollytelling map">
      ...
      >
        <p className="chart-caption text-left" style={{ paddingBottom: 0 }}>
          *2020 was selected because it is the most recent year with near-complete regional coverage, with data available for 11 of the 12 Pacific Island nations studied in this analysis.
        </p>
